 ...
 */
@protocol ISHPullUpSizingDelegate <NSObject>
 ...
 */
@interface ISHPullUpViewController : UBDefaultController
...
/// Height of bottom controller when the gesture begins
@property (nonatomic, assign) CGFloat bottomHeightAtStartOfGesture;

/// Gesture velocity when swiping bottom view
@property (nonatomic, assign) CGFloat bottomControllerVelocityAtSwipeOfGesture;
